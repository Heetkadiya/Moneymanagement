        ...
        while(n !=5)
        {
            ...
            if (n == 1)
            {
                ...
                if ((age > 130)||(age==0))
                {
                    ...
                    //System.exit(0);                                   //HERE WHEN I WRITE THIS CODE
                    //WHEN THE INPUT IS HAVING ERROR OR FAULTY VLUE THE THE PROGRAM WILL BE END SO
                    //TO AVOID THE TERMINATION IT SHOULD BE REMOVED
                }
                else if ((age > 0) && (age < 101))
                {
                    long anuualsalary = 12 * salary;
                    ...
                    if ((anuualsalary >= 10000) && (anuualsalary <= 100000))
                    {
                        ...
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        Moneymanagementsystem sal2 = new Moneymanagementsystem(anuualsalary, age, 3, 4, 2, 3, 4, 2);
                    }
                    if ((100001 <= anuualsalary) && (anuualsalary <= 249999))
                    {
                        ...
                        sal3.allocationfor100001_249999(anuualsalary, 3, 3, 4, 2, 3, 4, 2, 5, 3, 4, 2);
                    ...
                    if ((250000 <= anuualsalary) && (anuualsalary <= 499999))
                    {
                        ...
                        {
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            System.out.println("\"you fall under tax slab of income ranging from Rs. 2.5 lakh to ");
                            ...
                            long taxpay = (anuualsalary * 5) / 100;
                            anuualsalary = anuualsalary - taxpay;
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            System.out.println("\"THE TOTAL TAX YOU HAVE TO PAY IS" + taxpay);
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");

                            sal4.allocationfor250000to500000(anuualsalary, age, 3, 4, 2, 3, 4, 2, 5, 3, 4, 2, 4);
                        ...
                        if ((age > 60) && (age <= 80))
                        {
                            ...
                            {
                                System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                                System.out.println("As per your income you didnt fall into any tax slab so there is no need for tax paying.congrates");
                                System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                                Moneymanagementsystem sal4 = new Moneymanagementsystem();
                                sal4.allocationfor250000to500000(anuualsalary, age, 3, 3, 2, 3, 4, 2, 5, 3, 4, 2, 4);
                                //sal4.moneyremaining();
                            }
                        }
                        ...
                        {
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            System.out.println("\"you fall under tax slab of income ranging from Rs. 3 lakh to ");
                            System.out.println("Rs. 5 lakh.and you have to pay 5% of your income as a tax the amount ");
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            long taxpay = (anuualsalary * 5) / 100;
                            anuualsalary = anuualsalary - taxpay;
                    ...
                    if ((500000 <= anuualsalary) && (anuualsalary <= 700000))
                    {
                        if ((age <= 60) || ((age > 60) && (age <= 120)))
                        {
                            ...
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            long taxpay = (anuualsalary * 20) / 100;
                            anuualsalary = anuualsalary - taxpay;
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            System.out.println("\"THE TOTAL TAX YOU HAVE TO PAY IS" + taxpay);
                            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                            Moneymanagementsystem sal4 = new Moneymanagementsystem();
                            sal4.allocationfor5lakhto7lakh(anuualsalary, age, 2, 3, 4, 3, 6, 2, 2, 3, 4, 5, 3, 5);
                            sal4.taxredemption(taxpay);
                        }
                    }
                    if ((700000 <= anuualsalary) && (anuualsalary <= 1000000))
                    {
                        ...
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        Moneymanagementsystem sal4 = new Moneymanagementsystem();
                        sal4.allocationfor7lakhto10lakh(anuualsalary, age, 3, 2, 4, 5, 7, 3, 2, 5, 2, 3, 5, 4, 3, 2, 4);
                        sal4.taxredemption(taxpay);
                    }
                    if ((1000000 <= anuualsalary))
                    {
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\"you fall under tax slab of income ranging ");
                        System.out.println("Rs. 10 lakh.and you have to pay 30% of your income as a tax the amount ");
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        long taxpay = (anuualsalary * 30) / 100;
                        anuualsalary = anuualsalary - taxpay;
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        System.out.println("\"THE TOTAL TAX YOU HAVE TO PAY IS" + taxpay);
                        System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
                        Moneymanagementsystem sal4 = new Moneymanagementsystem();
                        sal4.allocationfor10lakhtogreater(anuualsalary, age, 3, 2, 3, 5, 4, 3, 2, 5, 2, 3, 3, 4, 3, 2, 4, 2, 2, 3);
                        sal4.taxredemption(taxpay);
                    }
                }
            }
