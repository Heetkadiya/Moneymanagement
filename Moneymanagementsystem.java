...
public class Moneymanagementsystem
{
    ...
    Moneymanagementsystem(long sal,int age,long a,long b,long c,long d, long e,long f)
    {
        long life_careexpensis = sal / a;
        sal = sal - life_careexpensis;
        long personalandfamily_savings = sal / b;
        sal = sal - personalandfamily_savings;
        long investing = sal / c;
        sal = sal - investing;
        long personalandfamilyexpenses = sal / d;
        sal = sal - personalandfamilyexpenses;
        long imediatefunds = sal / e;
        sal = sal - imediatefunds;
        long investinginrealestate= sal/f;
    ...
    void allocationfor100001_249999(long sal,int age, long a,long b,long c,long d, long e,long f,long g,long h,long i,long j)
    {
        long investingonbondaswellasonmutualfunds=sal/g;
        sal=sal-investingonbondaswellasonmutualfunds;
        long investinginrealestate= sal/h;
        sal=sal-investinginrealestate;
        long investmentingoldandcommodities=sal/i;
        sal=sal-investmentingoldandcommodities;
        long personalexpensesaswellascomfortliving=sal/j;
    ...
    void allocationfor250000to500000(long sal,int age,long a,long b,long c,long d, long e,long f,long g,long h,long i,long j,long k)
    {
    ...
    void allocationfor5lakhto7lakh(long sal,int age,long a,long b,long c,long d, long e,long f,long g,long h,long i,long j,long k,long l)
    {

        long Exchange_tradedfundsETF=sal/l;
    ...
    void allocationfor7lakhto10lakh(long sal,int age,long a,long b,long c,long d, long e,long f,long g,long h,long i,long j,long k,long l,long m,long n,long o)
    {

       long Cryptocurrencies=sal/m;
        sal=sal-Cryptocurrencies;
        long Peer_to_peerlending=sal/n;
        sal=sal-Peer_to_peerlending;
        long Artandcollectibles=sal/o;
    ...
    void allocationfor10lakhtogreater(long sal,int age,long a,long b,long c,long d, long e,long f,long g,long h,long i,long j,long k,long l,long m,long n,long o,long  p,long q,long r)
    {

        long private_equity=sal/p;
        sal=sal-private_equity;
        long venture_capital_funds=sal/q;
    ...
    void taxredemption(long taxpay)
    {
        System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
