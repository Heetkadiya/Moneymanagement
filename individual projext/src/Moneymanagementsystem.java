...
public class Moneymanagementsystem
{
    ...
    double moneyinhand;
    double taxpay;
    double life_careexpensis;
    double personalandfamily_savings;
    double investing;
    double personalandfamilyexpenses;
    double imediatefunds;
    double investinginrealestate;
    double Cryptocurrencies;
    double Exchange_tradedfundsETF;
    double Peer_to_peerlending;
    double Artandcollectibles;
    double Hedge_funds;
    double private_equity;
    double venture_capital_funds;
    //double taxpay;
    ...
    void checkag(int age)
    {
    }
    //  *****AS in  practicle life 50,30,20 ratio is implemented most of the time but divercifiying a portfoilio is someones personal choice so i made thi portfoilio desin
    ...
    Moneymanagementsystem(double sal,int age,double a,double b,double c,double d, double e,double f)
    {
       ...
       /* void allocatingsalary(double sal)
        {
            double life_careexpensis = sal / 5;
        sal = sal - life_careexpensis;
        double personalandfamily_savings = sal / 4;
        sal = sal - personalandfamily_savings;
        double investing = sal / 2.2;
        sal = sal - investing;
        double personalandfamilyexpenses = sal / 2;
        sal = sal - personalandfamilyexpenses;
        double imediatefunds = sal / 3;
        sal = sal - imediatefunds;
        double investinginrealestate= sal/4.44;
        sal=sal-investinginrealestate;
        moneyinhand=sal;
        System.out.println("For your investing purpose you should try sip in bluechip company or any other good mutual fund plan as ");
        System.out.println("per portfoilio given by the moneymanagement system  instead of going for ");
...
*/
        ...
        void allocationfor100001_249999(double sal,int age, double a,double b,double c,double d, double e,double f,double g,double h,double i,double j){
           ...
           sal=sal-investmentingoldandcommodities;
            ...
            System.out.println("FOR INVESTING  IN GOLD AND COMMODITIES YOU ARE SUGGESTED TO ALLOCATION OF MONEY SHOULD  BE"+"$"+investingonbondaswellasonmutualfunds);
            System.out.println("\"~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
            // System.out.println("~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~");
